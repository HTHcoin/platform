...
const schema = require('../../schema/hthcoin.schema.json');
    ...
    describe('Profile', () => {
      ...
      describe('avatarUrl', () => {
        ...
        it('should have less than 2048 chars length', async () => {
          profileData.avatarUrl = `https://github.com/hthcoin/hth/wiki/Whitepaper?text=${encodeURI(whitepaperMasternodeText)}${encodeURI(whitepaperMasternodeText)}${encodeURI(whitepaperMasternodeText)}${encodeURI(whitepaperMasternodeText)}${encodeURI(whitepaperMasternodeText)}`;
