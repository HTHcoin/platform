    ...
    platform: {
      ...
      properties: {
        ...
        drive: {
              ...
              properties: {
                ...
                validatorSet: {
                  ...
                  properties: {
                    llmqType: {
                      type: 'number',
                      // https://github.com/MichaelHDesigns/hthcore-lib/blob/286c33a9d29d33f05d874c47a9b33764a0be0cf1/lib/constants/index.js#L42-L57
                ...
                p2p: {
                  ...
                  properties: {
                    ...
                    persistentPeers: {
                      type: 'array',
                      items: {
                        $ref: '#/definitions/tenderhthNodeAddress',
                      },
                    },
                    seeds: {
                      type: 'array',
                ...
                log: {
                  ...
                  properties: {
                    level: {
                      ...
                      properties: {
                        'abci-client': {
                          $ref: '#/definitions/tenderhthLogModule',
                        },
                        blockchain: {
                          $ref: '#/definitions/tenderhthLogModule',
                        },
          ...
          required: ['mongodb', 'abci', 'tenderhth'],
          additionalProperties: false,
        },
        dpns: {
          type: 'object',
      ...
      required: ['dapi', 'drive', 'dpns', 'hthcoin', 'featureFlags', 'sourcePath', 'masternodeRewardShares'],
      additionalProperties: false,
    },
    externalIp: {
      type: ['string', 'null'],
