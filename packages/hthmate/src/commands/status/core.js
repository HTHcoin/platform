...
class CoreStatusCommand extends ConfigBaseCommand {
  ...
  async runWithDependencies(
    ...
    const insightURLs = {
      testnet: 'https://testnet-insight.hthcoin.org/insight-api',
      mainnet: 'https://insight.hth.org/insight-api',
    };
    ...
    let latestVersion;
    try {
      const latestVersionRes = await fetch('https://api.github.com/repos/hthcoin/hth/releases/latest');
    ...
    let coreVersion = networkInfo.subversion.replace(/\/|\(.*?\)|HTH Core:/g, '');
