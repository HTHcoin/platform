...
class MintCommand extends ConfigBaseCommand {
  ...
  async runWithDependencies(
    ...
    if (network !== NETWORK_LOCAL) {
      throw new Error('Only local network supports generation of hth');
    }

    const tasks = new Listr([
      {
        title: `Generate ${amount} hth to address`,
...
MintCommand.description = `Mint hth
...
Mint specified amount of hth to a new address or specified one
`;
...
MintCommand.args = [{
  name: 'amount',
  required: true,
  description: 'amount of hth to be generated to address',
